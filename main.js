const { app, BrowserWindow, nativeTheme, Menu, shell, dialog, ipcMain } = require('electron/main')
const path = require('node:path')
let file = {}
const fs = require('fs')


//Essa é a janela principal
let win
...
const template = [
    ...
    },
    {
        ...
        submenu: [
            {
                label: 'Repositório',
                click: () => shell.openExternal('https://github.com/BielCoutinho/Mini-Dev-Editor.git')
            },
            {
                label: 'Sobre',
                click: () => aboutWindow()
